...
echo "Gate count:"
bb gates -b target/zeroklue_jwt.json | jq '.functions[0].circuit_size'
...
cp target/zeroklue_jwt.json "../../zeroklue-app/packages/nextjs/public/circuits/circuit.json"

echo "Generating verification key..."
bb write_vk -b ./target/zeroklue_jwt.json -o ./target --oracle_hash keccak
