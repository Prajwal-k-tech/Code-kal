...
export const OfferStack = ({ offers, isUnlocked }: OfferStackProps) => {
  ...
  // Switch to grid layout when user scrolls down 300px (~2 scrolls)
  useMotionValueEvent(scrollY, "change", (latest) => {
    if (latest > 300 && layoutState !== "grid") {
      setLayoutState("grid");
    } else if (latest <= 300 && layoutState !== "fanned") {
  ...
  return (
    <div className="relative min-h-[1200px] w-full mt-0">
