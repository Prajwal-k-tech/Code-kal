      ...
      <div className="relative h-full flex flex-col p-6 text-white z-10 justify-between">
        ...
        {!minimal && (
          <div className="mt-4">
            {isUnlocked ? (
              offer.id === "2" ? (
                // Cyfrin Updraft - link to /merchant
                <div className="pt-4">
                  <Link href="/merchant" className="w-full block">
                ...
                <div className="pt-4">
                  <button className="w-full btn bg-white/20 text-white/60 border-none font-bold text-sm cursor-not-allowed" disabled>
                    Coming Soon
                  </button>
                </div>
              )
